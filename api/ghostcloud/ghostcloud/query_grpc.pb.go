...
const (
	Query_Params_FullMethodName  = "/ghostcloud.ghostcloud.Query/Params"
	Query_Metas_FullMethodName   = "/ghostcloud.ghostcloud.Query/Metas"
	Query_Content_FullMethodName = "/ghostcloud.ghostcloud.Query/Content"
)
...
func (c *queryClient) Metas(ctx context.Context, in *QueryMetasRequest, opts ...grpc.CallOption) (*QueryMetasResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_Metas_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
