...
func init() {
	...
	md_Meta = File_ghostcloud_ghostcloud_meta_proto.Messages().ByName("Meta")
...
func (x *Meta) slowProtoReflect() protoreflect.Message {
	mi := &file_ghostcloud_ghostcloud_meta_proto_msgTypes[0]
...
func (x *fastReflection_Meta) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "ghostcloud.ghostcloud.Meta.creator":
		return x.Creator != ""
	case "ghostcloud.ghostcloud.Meta.name":
		return x.Name != ""
	case "ghostcloud.ghostcloud.Meta.description":
		return x.Description != ""
	case "ghostcloud.ghostcloud.Meta.domain":
		return x.Domain != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ghostcloud.ghostcloud.Meta"))
		}
		panic(fmt.Errorf("message ghostcloud.ghostcloud.Meta does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Meta) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message ghostcloud.ghostcloud.Meta does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Meta) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "ghostcloud.ghostcloud.Meta.creator":
		panic(fmt.Errorf("field creator of message ghostcloud.ghostcloud.Meta is not mutable"))
	case "ghostcloud.ghostcloud.Meta.name":
		panic(fmt.Errorf("field name of message ghostcloud.ghostcloud.Meta is not mutable"))
	case "ghostcloud.ghostcloud.Meta.description":
		panic(fmt.Errorf("field description of message ghostcloud.ghostcloud.Meta is not mutable"))
	case "ghostcloud.ghostcloud.Meta.domain":
		panic(fmt.Errorf("field domain of message ghostcloud.ghostcloud.Meta is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: ghostcloud.ghostcloud.Meta"))
		}
...
func (x *fastReflection_Meta) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in ghostcloud.ghostcloud.Meta", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Meta) Descriptor() ([]byte, []int) {
	return file_ghostcloud_ghostcloud_meta_proto_rawDescGZIP(), []int{0}
}
...
var File_ghostcloud_ghostcloud_meta_proto protoreflect.FileDescriptor

var file_ghostcloud_ghostcloud_meta_proto_rawDesc = []byte{
	0x0a, 0x20, 0x67, 0x68, 0x6f, 0x73, 0x74, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2f, 0x67, 0x68, 0x6f,
	0x73, 0x74, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2f, 0x6d, 0x65, 0x74, 0x61, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x12, 0x15, 0x67, 0x68, 0x6f, 0x73, 0x74, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x67,
	0x68, 0x6f, 0x73, 0x74, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x1a, 0x19, 0x63, 0x6f, 0x73, 0x6d, 0x6f,
	0x73, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x88, 0x01, 0x0a, 0x04, 0x4d, 0x65, 0x74, 0x61, 0x12, 0x32, 0x0a,
	...
	0xd7, 0x01, 0x0a, 0x19, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x68, 0x6f, 0x73, 0x74, 0x63, 0x6c, 0x6f,
	0x75, 0x64, 0x2e, 0x67, 0x68, 0x6f, 0x73, 0x74, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x42, 0x09, 0x4d,
	0x65, 0x74, 0x61, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x3a, 0x67, 0x69, 0x74, 0x68,
...
var (
	file_ghostcloud_ghostcloud_meta_proto_rawDescOnce sync.Once
	file_ghostcloud_ghostcloud_meta_proto_rawDescData = file_ghostcloud_ghostcloud_meta_proto_rawDesc
)

func file_ghostcloud_ghostcloud_meta_proto_rawDescGZIP() []byte {
	file_ghostcloud_ghostcloud_meta_proto_rawDescOnce.Do(func() {
		file_ghostcloud_ghostcloud_meta_proto_rawDescData = protoimpl.X.CompressGZIP(file_ghostcloud_ghostcloud_meta_proto_rawDescData)
	})
	return file_ghostcloud_ghostcloud_meta_proto_rawDescData
}

var file_ghostcloud_ghostcloud_meta_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_ghostcloud_ghostcloud_meta_proto_goTypes = []interface{}{
	(*Meta)(nil), // 0: ghostcloud.ghostcloud.Meta
}
var file_ghostcloud_ghostcloud_meta_proto_depIdxs = []int32{
...
func init() { file_ghostcloud_ghostcloud_meta_proto_init() }
func file_ghostcloud_ghostcloud_meta_proto_init() {
	if File_ghostcloud_ghostcloud_meta_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_ghostcloud_ghostcloud_meta_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Meta); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ghostcloud_ghostcloud_meta_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_ghostcloud_ghostcloud_meta_proto_goTypes,
		DependencyIndexes: file_ghostcloud_ghostcloud_meta_proto_depIdxs,
		MessageInfos:      file_ghostcloud_ghostcloud_meta_proto_msgTypes,
	}.Build()
	File_ghostcloud_ghostcloud_meta_proto = out.File
	file_ghostcloud_ghostcloud_meta_proto_rawDesc = nil
	file_ghostcloud_ghostcloud_meta_proto_goTypes = nil
	file_ghostcloud_ghostcloud_meta_proto_depIdxs = nil
}
